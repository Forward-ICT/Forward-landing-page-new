...
const GamesShowcase = () => {
  ...
  return (
    <section id="games" className="py-20 px-4 bg-gradient-to-b from-transparent to-gray-800/50">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Featured <span className="bg-gradient-to-r from-green-400 to-green-600 bg-clip-text text-transparent">Games</span>
          </h2>
